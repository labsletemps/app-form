...
SURTITRE = 'CONQUETE SPACIALE'
SOUSTITRE = ''# Project name to be used in urls
# Use dashes, not underscores!
PROJECT_SLUG = 'mars'

# The name of the repository containing the source
REPOSITORY_NAME = 'template-form'
REPOSITORY_URL = 'git@github.com:dataletemps/%s.git' % REPOSITORY_NAME
REPOSITORY_ALT_URL = None # 'git@bitbucket.org:dataletemps/%s.git' % REPOSITORY_NAME'

# Project name used for assets rig
# Should stay the same, even if PROJECT_SLUG changes
ASSETS_SLUG = 'template-form'

# Project name to be used in file paths
PROJECT_FILENAME = 'template-form'
...
COPY EDITING
"""
COPY_GOOGLE_DOC_KEY = '1_DYQkTP8Sn7UhB3mpjpddA7vNuBQYWZpc8MJzl5AnvI'
COPY_PATH = 'data/copy.xlsx'

"""
SHARING
"""
PROJECT_DESCRIPTION = "Face au rechauffement climatique, les villes sont a la fois le probleme et la solution."
SHARE_URL = 'http://%s/%s/' % (PRODUCTION_S3_BUCKETS[0], PROJECT_SLUG)

# Will be resized to 120x120, can't be larger than 1MB
TWITTER_IMAGE_URL = 'http://%s/%s/assets/img/twitter.jpg' % (PRODUCTION_S3_BUCKETS[0], PROJECT_SLUG)
TWITTER_HANDLE = '@dataletemps'
