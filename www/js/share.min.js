    ...
    Share = function(t) {
        function e(t, e) {
            ...
            return this.element = t, this.el = {
                ...
                ui: {
                    flyout: "top center",
                    button_text: "&nbsp<i class='fa fa-share' style='position:absolute;top:8px;'>&nbsp;partagez",
                    button_font: !0,
                    icon_font: !0
                },
                networks: {
        ...
        return __extends(e, t), e.prototype.setup = function(t, e) {
            ...
            return this.inject_stylesheet("font/entypo.min.css")
            ...
            return t.innerHTML = "<label class='entypo-export'><span>" + this.config.ui.button_text + "</span></label><div class='social load " + this.config.ui.flyout + "'><ul><li class='entypo-twitter' data-network='twitter'></li><li class='entypo-facebook' data-network='facebook'></li><li class='entypo-gplus' data-network='google_plus'></li><li class='entypo-paper-plane' data-network='email'></li></ul></div>"
